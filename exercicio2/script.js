// 1Escreva um programa que faça 3 perguntas de Sim ou Não, e guarde cada resposta em uma variável. Por exemplo: "Você está usando uma roupa azul hoje?". Depois, siga os passos:

//a) Crie três novas variáveis, contendo as respostas;
let voceEstaUsandoCalcinha =  false
let voceTeveUmDiaBom = true
let querIrDormir = false


//b) Imprima na tela todas as respostas. Por exemplo:
console.log(typeof voceEstaUsandoCalcinha)
console.log(typeof voceTeveUmDiaBom)
console.log(typeof querIrDormir)
...
const perguntaA = prompt("voceEstaUsandoCalcinha?")

...
const pressao_PR = prompt("Você tem pressão alta? -", pressao_P);
var mais30_P = prompt("Você tem mais de 30 anos?");
var mais30_R = prompt(mais30_P);
var mais30_PR = prompt("Você tem mais de 30 anos? -", mais30_P);
let cirurgia_P = prompt("Você já fez alguma cirurgia?");
let cirurgia_R = prompt(cirurgia_P);
let cirurgia_PR = prompt("Você já fez alguma cirurgia? -", cirurgia_P);
